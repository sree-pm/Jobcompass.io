...
import { Row, Btn, Tag, Card } from "../common/UiPrimitives.jsx";
...
export function ApplyDispatchDrawer({ job, candidate, tailorResult, onClose, onAppliedSuccess }) {
  ...
  return (
    ...
    >
      <div style={{ padding: "16px 20px", background: T.bg, borderBottom: `1px solid ${T.border}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <div style={{ fontSize: 14, fontWeight: 800, color: T.text }}>1-Click Apply Dispatch Helper</div>
      ...
      <div style={{ padding: 18, overflowY: "auto", flex: 1, display: "flex", flexDirection: "column", gap: 14 }}>
        <Card style={{ padding: 12 }}>
          <div style={{ fontSize: 12, fontWeight: 700, marginBottom: 8, color: T.text }}>1. Candidate Details</div>
        ...
        <Card style={{ padding: 12 }}>
          <div style={{ fontSize: 12, fontWeight: 700, marginBottom: 4, color: T.text }}>2. Tailored A4 Resume</div>
          <div style={{ fontSize: 11, color: T.muted, marginBottom: 8 }}>British English · £ Metrics · Verified 0 Hallucination</div>
        ...
        <Card style={{ padding: 12 }}>
          <div style={{ fontSize: 12, fontWeight: 700, marginBottom: 4, color: T.text }}>3. Understated UK Cover Letter</div>
          <div style={{ fontSize: 11, color: T.muted, marginBottom: 8 }}>300–340 words tailored to {job.company}</div>
        ...
        <Card style={{ padding: 12 }}>
          <div style={{ fontSize: 12, fontWeight: 700, marginBottom: 8, color: T.text }}>4. ATS Screening Answers</div>
      ...
      <div style={{ padding: 16, background: T.bg, borderTop: `1px solid ${T.border}` }}>
        <Btn variant="indigo" size="md" onClick={onAppliedSuccess} style={{ width: "100%" }}>
