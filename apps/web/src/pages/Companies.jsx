    ...
    <MarketingLayout>
      <section style={{ maxWidth:1100, margin:"0 auto", padding:"40px 24px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))", gap:12, marginTop:16 }}>
          ...
          {!rows.length && <div style={{ color:T.muted, fontSize:12, background:T.surface, border:`1px dashed ${T.border}`, borderRadius:10, padding:16, textAlign:"center" }}>No companies yet — they appear as roles are ingested and enriched daily.</div>}
        </div>
      </section>
    </MarketingLayout>
  );
